...
@pytest.mark.parametrize(
    ...
    [
        pytest.param({"nodes": [], "env": {"status": 1}}, EnvStatus.Running),
        pytest.param({"nodes": [], "env": {"status": 2}}, EnvStatus.Down),
        pytest.param({"nodes": [], "env": {"status": 5}}, EnvStatus.Unknown),
        pytest.param({"nodes": [], "env": {"status": 8}}, EnvStatus.NotExists),
        pytest.param({"nodes": [], "env": {"status": 13}}, EnvStatus.Stopping),
    ],
)
def test_env_info_status(input_dict: dict, expected_status: EnvStatus):
    # Arrange
...
def test_env_info_env_name():
    ...
    input_dict = {"nodes": [], "env": {"envName": expected_env_name}}
    env_info = EnvInfo(input_dict)
...
def test_env_info_domain():
    ...
    input_dict = {"nodes": [], "env": {"domain": expected_domain}}
    env_info = EnvInfo(input_dict)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param({"nodes": [], "env": {"status": 1}}, True),
        pytest.param({"nodes": [], "env": {"status": 2}}, False),
        pytest.param({"nodes": [], "env": {"status": 10}}, False),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param({"nodes": [], "env": {"status": 1}}, True),
        pytest.param({"nodes": [], "env": {"status": 2}}, True),
        pytest.param({"nodes": [], "env": {"status": 10}}, True),
        pytest.param({"nodes": [], "env": {"status": 8}}, False),
        pytest.param({"nodes": [], "env": {"status": 5}}, False),
    ],
)
        ...
        pytest.param(
            {
                ...
                "env": {"envName": "local-sha-master-0954606", "status": 1},
            },
            "cp",
            None,
            ["10.102.15.248"],
            id="filter list of 1 node on existing node group",
        ),
        pytest.param(
            {
                "nodes": [
            ...
            "docker",
            ["10.102.15.248"],
            id="filter list of 1 node on existing node type",
        ),
        pytest.param(
            {
                "nodes": [
            ...
            "vps",
            [],
            id="filter list of 1 node on non-existent node type",
        ),
        pytest.param(
            {
                "nodes": [
            ...
            None,
            [],
            id="filter list of 1 node on non-existent node group",
        ),
        pytest.param(
            {
                "nodes": [
            ...
            "cp",
            None,
            ["10.102.15.248", "10.102.15.249", "10.102.15.250"],
...
def test_env_info_get_node_ips_returns_filtered_ips(
    ...
    # Act
    actual_ips = env_info.get_node_ips(node_group=node_group, node_type=node_type)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            "target-node",
            "10.102.15.248",
            id="list of multiple nodes containing the desired display name",
        ),
        pytest.param(
            {
                "nodes": [
            ...
            "target-node",
            None,
            id="list of multiple nodes not containing the desired display name",
        ),
    ],
)
def test_env_info_get_node_ip_from_name_returns_corresponding_ip(
    input_dict: dict, display_name: str, expected_ip: str
):
    # Arrange
    env_info = EnvInfo(input_dict)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            "target-node",
            "node89876-local-sha-master-0954606.hidora.com",
            id="list of 1 node with desired display name",
        ),
        pytest.param(
            {
        ...
        pytest.param(
            ...
            "target-node",
            "node89886-local-sha-master-0954656.hidora.com",
            id="list of multiple nodes with the desired display name",
        ),
    ],
)
def test_env_info_get_node_hostname_from_name_returns_hostname(
    input_dict: dict, display_name: str, expected_hostname: str
):
    # Arrange
    env_info = EnvInfo(input_dict)
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            "target-node",
            "http://node89876-local-sha-master-0954606.hidora.com",
            id="list of 1 node with desired display name",
        ),
        pytest.param(
            {
        ...
        pytest.param(
            ...
            "target-node",
            "http://node89886-local-sha-master-0954656.hidora.com",
            id="list of multiple nodes with the desired display name",
        ),
    ],
)
